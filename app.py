...
Covid_spread_clusters_text = html.Div([
    ...
    " included US counties. The silhouette score was equal to 0.2169. To investigate whether K-means clustering"
    " led to other clusters, a new pipeline was tuned, removing the option spectral clustering from the parameters. "
    "This resulted in the clusters that are displayed on the map. The MinMaxScaler, OneClassSVM and 2 principal"
    " components were chosen and the silhouette score was 0.1566, which is not much lower"
